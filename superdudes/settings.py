...
ADMINS = (
    # ('Your Name', 'your_email@superdudes.com'),
)
...
ROOT_URLCONF = 'superdudes.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'superdudes.wsgi.application'
...
SOCIAL_AUTH_EMAIL_VALIDATION_FUNCTION = 'superdudes.app.mail.send_validation'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'superdudes.app.pipeline.require_email',
...
#Facebook
SOCIAL_AUTH_FACEBOOK_KEY = '1442312899347550'
SOCIAL_AUTH_FACEBOOK_SECRET = '29689f6d039690ace8eaa8c71abdf64a'
